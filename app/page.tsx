...
export default function AbstractDesignPage() {
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden">
      ...
      {/* Content */}
      <main className={`relative z-10 flex min-h-screen flex-col items-center pt-22 px-4 transition-opacity duration-1000 ${loaded ? 'opacity-100' : 'opacity-0'}`}>

        <div className="w-full max-w-4xl rounded-xl bg-white/80 p-8 backdrop-blur-sm">
          <h2 className="mb-3 text-md md:text-xl font-semibold text-center text-emerald-700">1700 Shady Oaks Drive, Suite 118</h2>
          ...
          <div className="grid grid-cols-1">
            <div className="rounded-lg bg-slate-100 p-6 shadow-sm">
              <h2 className="mb-3 text-xl font-semibold text-emerald-700">Find Us</h2>

              <p className="text-gray-600 pb-5">We&apos;re located in Denton, Texas, just a short drive from major highways for easy access.</p>
              <ul className="list-disc pl-5">
                <li>If you&apos;re coming from Dallas or Fort Worth, take I-35E North and exit onto Loop 288. From there, it&apos;s a quick drive west to Shady Oaks Drive.
                </li>
                <li>From Denton and the surrounding area, you can take Loop 288 or University Drive (US-380) and head toward Shady Oaks Drive.
                </li>
                <li>
                  If you&apos;re traveling via I-35W, merge onto I-35E North near Denton, then follow the same Loop 288 exit.
                </li>
              </ul>
              <p className="text-gray-600 pt-5">Look for us just off Shady Oaks Drive, close to the heart of Denton!
              </p>
