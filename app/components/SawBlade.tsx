    ...
    <>
      <div className="relative">
        <div className="relative z-[200]">
          <div
            ref={sawRef}
            className="fixed pointer-events-none top-0 left-0 w-full h-full flex justify-center items-center filter drop-shadow-lg will-change-transform origin-center"
            style={{
