    ...
    <div>
      ...
      <div className="flex gap-4">
        <div className="mx-5 md:mx-0 md:flex-2/3">
          <div className="h-full text-base bg-white/80 rounded-lg p-5 border-1 border-primary">
            <p>
        ...
        <div className="h-full hidden md:block md:flex-1/3 rounded-lg overflow-hidden">
          <Image
            src="/sawblade.jpg"
